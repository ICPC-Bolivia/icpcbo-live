...
assert_equals "contest" "${CONTEST_DIR}" "CONTEST_DIR"
...
assert_file "overlay/etc/systemd/system/contest-uninstall.service"
assert_file "overlay/usr/lib/contest/deploy.sh"
assert_file "overlay/usr/lib/contest/uninstall.sh"
assert_file "overlay/usr/lib/contest/clean-home.sh"
...
assert_executable "overlay/usr/lib/contest/uninstall.sh"
assert_executable "overlay/usr/lib/contest/clean-home.sh"
...
if rg -n -i "nutella" \
    ...
    "${PROJECT_DIR}/docker/apt-cacher-ng/Dockerfile" \
    >/dev/null; then
